	...
	function layer(selection) {
		selection.each(function(data) {
                ...
                function mouseHandler() {
                    ...
                    // kgd 130914 --- point hack
                    // pointIndex = nv.interactiveBisect(data[0].values, pointXValue, chart.x());
                    // radio('nvMousemove').broadcast({'pointXValue': pointXValue});
                    PubSub.publish('nvMousemove', [{'pointXValue': pointXValue}]);
                    // end kgd broadcast
    ...
    selection.each(function(data) {
      ...
      interactiveLayer.dispatch.on('elementMousemove', function(e) {
          ...
          .forEach(function(series,i) {
              ...
              if (typeof point === 'undefined') return;
              // kgd 130914 --- point hack
              // radio('nvMouseover').broadcast({'datapoint': point});
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      interactiveLayer.dispatch.on('elementMousemove', function(e) {
          ...
          var singlePoint, pointIndex, pointXLocation, allData = [];
              // kgd 130914 --- point hack
              // pointIndex = nv.interactiveBisect(data[0].values, e.pointXValue, chart.x());
              // radio('nvMouseover').broadcast({'datapoint': pointIndex});
          // end kgd broadcast
          data
          .filter(function(series, i) {
            series.seriesIndex = i;
