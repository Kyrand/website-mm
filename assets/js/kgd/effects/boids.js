...
`
 ...
 function init() {
   ...
   container = document.getElementById("boids-tank")
   if(!container) return
 ...
 function initComputeRenderer() {
   ...
   velocityVariable = gpuCompute.addVariable( "textureVelocity", FSVel, dtVelocity );
   positionVariable = gpuCompute.addVariable( "texturePosition", FSPos, dtPosition );
